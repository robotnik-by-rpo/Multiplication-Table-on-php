<?php
    ...
    if ($_POST){
        ...
        if (!$errors) {
            ...
            $record = [
                escapeDelimiter($subDate),
                escapeDelimiter($ip),
                escapeDelimiter($_POST['name']),
                escapeDelimiter($_POST['lastname']),
                escapeDelimiter($_POST['phone']),
                escapeDelimiter($_POST['email']),
                escapeDelimiter($_POST['themes'] . ':' . $themes[$_POST['themes']]),
                escapeDelimiter($_POST['wallet'] . ':' . $wallet[$_POST['wallet']]),
                escapeDelimiter($_POST['agreement'])
            ];
            $line = implode('|', $record) . "\n";
            ...
            file_put_contents('./form/reg.csv', $line, FILE_APPEND | LOCK_EX);
